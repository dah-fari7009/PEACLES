...
class __TwigTemplate_25ebee5ddb1960a2cdb320613630418abaa46fb710d9628de93881130fc5a7bf extends \Twig\Template
{
    private $source;
...
$context["key"] == "hit_read_ratio")) {
                            // line 113
                            echo "                                                ";
                            (((twig_get_attribute($this->env, $this->source, $context["value"], "value", [], "any", true, true) &&  !(null === twig_get_attribute($this->env, $this->source, $context["value"], "value", [])))) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["value"], "value", []), "html", null, true))) : (print (0)));
                            echo " <span class=\"unit\">%</span>
                                            ";
                        } else {
                            // line 115
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/mnt/c/Users/farid/Desktop/Trd_Year/PW6/easyCheesy/PEAsyCheesyLEmonSqueezy/PEACLES/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
