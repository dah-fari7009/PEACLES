...
class __TwigTemplate_8f794af88890f34800404ac0d0f5ef19b890f273d520e995e92dc40db5bb0ae4 extends \Twig\Template
{
    private $source;
...
$context["log"], "priorityName", []) == "WARNING")) ? ("status-warning") : (""))))));
                ...
                if ((isset($context["channel_is_defined"]) || array_key_exists("channel_is_defined", $context) ? $context["channel_is_defined"] : (function () { throw new RuntimeError('Variable "channel_is_defined" does not exist.', 208, $this->source); })())) {
                    ...
                    (( !(null === twig_get_attribute($this->env, $this->source, $context["log"], "channel", []))) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["log"], "channel", []), "html", null, true))) : (print ("")));
                    echo "\"";
                }
                echo ">
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/mnt/c/Users/farid/Desktop/Trd_Year/PW6/easyCheesy/PEAsyCheesyLEmonSqueezy/PEACLES/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
}
